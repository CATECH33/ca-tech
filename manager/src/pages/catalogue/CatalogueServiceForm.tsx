...
function SeoPreview({ title, description }: { title: string; description: string }) {
  const displayTitle = title || 'Titre SEO du service'
  ...
  return (
    <div className="mt-3 rounded-xl border border-gray-100 bg-gray-50 p-3">
      ...
      <p className="text-[11px] text-[#006621] mt-0.5">ca-tech.fr › services › …</p>
      ...
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate('/catalogue/services')}
            ...
            <div>
              <div className="flex items-center gap-2 text-xs text-gray-400 mb-0.5">
                ...
                <button onClick={() => navigate('/catalogue/services')} className="hover:text-gray-600 transition-colors">Services</button>
                <span>/</span>
          ...
          <div className="space-y-5">
            ...
            <Card>
              ...
              <div className="space-y-4">
                <Input
                  label="Nom *"
                  placeholder="Ex : Site Vitrine Premium"
                  value={form.nom}
                ...
                <Select
                  ...
                  options={CAT_OPTIONS}
                  onChange={e => set('categorie', e.target.value as CatalogueCategorie)}
                />
            ...
            <Card>
              ...
              <Textarea
                placeholder="Décrivez le service en détail : ce qui est inclus, le déroulé, les livrables, les délais…"
