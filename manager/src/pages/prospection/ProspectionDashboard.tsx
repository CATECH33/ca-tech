...
export function ProspectionDashboard() {
  return (
    <Layout title="Tableau de bord — Prospection IA">
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-5">
        ...
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-base font-semibold text-gray-900 mt-3">Tableau de bord</h2>
          <p className="text-sm text-gray-400 mt-1.5 leading-relaxed">
            Vue d'ensemble de vos campagnes de prospection, KPIs et activité récente.
          </p>
        </div>
      </div>
    </Layout>
