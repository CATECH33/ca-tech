...
async function getAccessToken(supabase: ReturnType<typeof createClient>): Promise<{
  ...
  // Solo system — exactly one record in google_integrations
  ...
  if (!g.refresh_token) throw new Error('Token expiré — reconnectez votre compte Google')
